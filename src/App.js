...
const FolderCogIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-folder-cog"><path d="M4 20h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.93a2 2 0 0 1-1.66-.9l-.82-1.2A2 2 0 0 0 4 3H2v15a2 2 0 0 0 2 2Z"/><circle cx="12" cy="13" r="3"/><path d="M12 10v1"/><path d="M12 15v1"/><path d="m16.96 14.96-.7.7"/><path d="m7.74 10.26-.7-.7"/><path d="m16.26 10.26.7.7"/><path d="m7.04 14.96.7.7"/></svg>;
...
const GithubIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-github"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.44-.78-3.46 0 0-1.09-.35-3.57 1.34A7.36 7.36 0 0 0 12 6.32c-1.28 0-2.5.28-3.66.83-2.48-1.69-3.57-1.34-3.57-1.34A3.71 3.71 0 0 0 2 7.9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>;
const LinkedinIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-linkedin"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>;


// --- Navigation Component ---
const Navbar = ({ setCurrentPage }) => { // Receive setCurrentPage as prop
              ...
              <li key={link.name}>
                <a
                  ...
                  className={`flex items-center space-x-2 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium transition-colors rounded-md p-2
                    ${activePage === link.path ? 'bg-blue-100 dark:bg-blue-700 text-blue-800 dark:text-white' : ''}`}
                >
  ...
  <footer className="w-full bg-gray-100 dark:bg-gray-900 text-gray-600 dark:text-gray-400 py-6 text-center mt-auto rounded-t-lg shadow-inner">
    <div className="container mx-auto px-4">
      ...
      <div className="flex justify-center space-x-4 mt-2">
        <a href="https://github.com/your-username" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors rounded-full p-2 hover:bg-gray-200 dark:hover:bg-gray-700" aria-label="GitHub profile">
          <GithubIcon className="w-6 h-6" />
        </a>
        <a href="https://linkedin.com/in/your-username" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors rounded-full p-2 hover:bg-gray-200 dark:hover:bg-gray-700" aria-label="LinkedIn profile">
...
// --- Home Page Component ---
const HomePage = ({ setCurrentPage }) => ( // Receive setCurrentPage to navigate
  <section id="home" className="flex flex-col items-center justify-center min-h-[calc(100vh-12rem)] py-16 px-4 text-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-800 dark:to-gray-900 rounded-lg shadow-xl">
    <div className="max-w-4xl mx-auto">
      ...
      <p className="text-xl text-gray-700 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
        ...
        interactive and user-friendly web applications. I thrive on bringing ideas to life through elegant code and
...
const AboutPage = () => (
  <section id="about" className="min-h-[calc(100vh-12rem)] py-16 px-4 bg-white dark:bg-gray-800 rounded-lg shadow-xl">
      ...
      <div className="grid md:grid-cols-2 gap-10 items-center">
        <div>
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
            Hello! I'm a dedicated frontend developer with a passion for creating engaging and
            intuitive user experiences. My journey into web development began with a fascination for
            how interactive interfaces are built, and since then, I've been continuously learning
            and honing my skills.
          </p>
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
            I specialize in building responsive web applications using modern JavaScript frameworks,
            with a strong focus on **React**. I love turning complex problems into simple, beautiful,
            and efficient solutions. When I'm not coding, you can find me exploring new technologies,
        ...
        <div className="bg-gray-50 dark:bg-gray-700 p-8 rounded-xl shadow-md">
          ...
          <ul className="grid grid-cols-2 sm:grid-cols-3 gap-4 text-gray-700 dark:text-gray-300 text-lg">
            {['React', 'JavaScript (ES6+)', 'TypeScript', 'HTML5', 'CSS3', 'Tailwind CSS',
             'RESTful APIs', 'Git', 'Redux (or Zustand)', 'Webpack/Vite', 'Unit Testing (Jest/RTL)', 'Figma Basics'].map((skill) => (
              <li key={skill} className="flex items-center space-x-2">
                <span className="text-blue-600 dark:text-blue-400 font-semibold text-xl">&bull;</span>
                <span>{skill}</span>
              </li>
            ))}
          </ul>
...
const ProjectCard = ({ project }) => (
  <div className="bg-white dark:bg-gray-700 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden">
    <img
      ...
      onError={(e) => { e.target.onerror = null; e.target.src = "https://placehold.co/400x200/E0F2F7/007bff?text=Project+Image"; }}
    />
    <div className="p-6">
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        {project.technologies.map((tech) => (
          <span key={tech} className="bg-blue-100 dark:bg-blue-800 text-blue-800 dark:text-blue-200 text-xs font-semibold px-3 py-1 rounded-full">
            {tech}
          </span>
        ))}
      </div>
  ...
  const projects = [
    {
      ...
      description: 'A responsive e-commerce platform built with React, featuring product listings, shopping cart, and user authentication. Integrates a fake API for product data.',
      image: 'https://placehold.co/600x400/add8e6/000?text=E-commerce+App',
      technologies: ['React', 'Tailwind CSS', 'React Router', 'Context API', 'Axios'],
    ...
    },
    {
      ...
      description: 'An interactive task management dashboard with drag-and-drop functionality, project categorization, and real-time updates. Demonstrates advanced state management.',
      image: 'https://placehold.co/600x400/90ee90/000?text=Task+Manager',
      technologies: ['React', 'Zustand', 'Drag & Drop API', 'TypeScript', 'Tailwind CSS'],
      liveLink: 'https://example.com/task-dashboard',
      githubLink: 'https://github.com/your-username/task-manager',
    },
    {
      id: 3,
      title: 'Interactive Data Visualization',
      description: 'A web application displaying real-time stock market data using Recharts for interactive graphs and charts. Features customizable data views.',
      image: 'https://placehold.co/600x400/ffb6c1/000?text=Data+Viz+App',
      technologies: ['React', 'Recharts', 'Fetch API', 'React Query', 'Tailwind CSS'],
      liveLink: 'https://example.com/data-viz',
      githubLink: 'https://github.com/your-username/data-visualization',
    },
    {
      id: 4,
      title: 'Portfolio Website (This one!)',
      description: 'This very website, showcasing responsive design, theme switching, modern React practices, and efficient component structure.',
      image: 'https://placehold.co/600x400/d3d3d3/000?text=Portfolio+Site',
      technologies: ['React', 'Tailwind CSS', 'Context API', 'React Router', 'lucide-react'],
      liveLink: '#', // Link to itself
      githubLink: 'https://github.com/your-username/your-portfolio',
    },
  ];

  return (
    <section id="projects" className="min-h-[calc(100vh-12rem)] py-16 px-4 bg-gray-50 dark:bg-gray-900 rounded-lg shadow-xl">
...
const ContactPage = () => {
  ...
  return (
    <section id="contact" className="min-h-[calc(100vh-12rem)] py-16 px-4 bg-white dark:bg-gray-800 rounded-lg shadow-xl">
      <div className="container mx-auto max-w-3xl">
        ...
        <form onSubmit={handleSubmit} className="bg-gray-50 dark:bg-gray-700 p-8 rounded-xl shadow-md space-y-6">
          ...
          {status === 'success' && (
            <p className="mt-4 text-center text-green-600 dark:text-green-400">Message sent successfully!</p>
          )}
          {status === 'error' && (
            <p className="mt-4 text-center text-red-600 dark:text-red-400">Something went wrong. Please try again later.</p>
          )}
        </form>
      </div>
    </section>
...
function App() {
  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen flex flex-col"> {/* Removed font-sans, antialiased, bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-200, transition-colors duration-300 from here */}
        <Navbar setCurrentPage={setCurrentPage} /> {/* Pass setCurrentPage down */}
        <main className="flex-grow container mx-auto px-4 py-8 mt-20 mb-8"> {/* Added margin-top to clear fixed navbar */}
          {renderPage()}
        </main>
        <Footer />
      </div>
